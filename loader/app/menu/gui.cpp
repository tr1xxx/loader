...
void menu::init()
{
	...
	colors[ImGuiCol_WindowBg] = ImVec4(0.20f, 0.22f, 0.25f, 1.00f);
	colors[ImGuiCol_ChildWindowBg] = menu_helpers::main_light_grey;
	colors[ImGuiCol_PopupBg] = ImVec4(0.05f, 0.05f, 0.10f, 0.90f);
	colors[ImGuiCol_Border] = ImVec4(1, 1, 1, .0f);
...
void menu::setup_menu()
{
	...
	wc = { sizeof(WNDCLASSEX), NULL, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, (VMProtectDecryptStringA("Cheat Loader")
		), NULL };
	::RegisterClassEx(&wc);
	hwnd = ::CreateWindow(wc.lpszClassName, ((VMProtectDecryptStringA("Cheat Loader"))), 0, 1100, 300, 600, 400, NULL, NULL, wc.hInstance, NULL);
